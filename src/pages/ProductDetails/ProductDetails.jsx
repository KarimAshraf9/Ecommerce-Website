        ...
        <div className="productInfo md:w-[60%]">
          ...
          <div className="text-center">
            <button
              ...
              className="w-3/4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center inline-flex justify-center items-center mt-5"
            >
              <svg
